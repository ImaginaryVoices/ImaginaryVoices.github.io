...
var getColorB = function(rrr) {
    ...
    //                        'rgba(001,133,133,0)';
    return  rrr <  -0.30 ? 'rgba(166, 73, 29,0.7)':
            rrr <  -0.20 ? 'rgba(180,110, 22,0.7)':
            rrr <  -0.10 ? 'rgba(205,149,  9,0.7)':
            rrr <   0.00 ? 'rgba(238,203, 53,0.7)':
            rrr ==  0.00 ? 'rgba(001,133,133,0)':
            rrr <=  0.10 ? 'rgba(171,219, 64,0.7)':
            rrr <=  0.20 ? 'rgba( 79,179, 24,0.7)':
            rrr <=  0.30 ? 'rgba( 58,136, 27,0.7)':
            rrr <=  0.40 ? 'rgba( 41, 93, 29,0.7)':
                           'rgba(001,133,133,0)';
