...
var contenu = {
    content:'En la barra de la izquierda encontrarás más información sobre este mapa interactivo. Selecciona:<br> &nbsp;<i class="fa fa-line-chart"> para consultar un breve análisis de los datos.<br> &nbsp;<i class="fa fa-info"></i> para consultar la descripción de las variables desplegadas. <br><br><small>Pronóstico emitido el 13.08.2021.</small>'
};
