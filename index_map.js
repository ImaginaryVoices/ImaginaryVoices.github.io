...
var getColorB = function(rrr) {
    ...
    //                        'rgba(001,133,133,0)';
    return  rrr <  -0.30 ? 'rgb(81   9 121)':
            rrr <  -0.20 ? 'rgb(149  15 223)':
            rrr <  -0.10 ? 'rgb(183  75 243)':
            rrr <   0.00 ? 'rgb(203 126 246)':
            rrr ==  0.00 ? 'rgba(001,133,133,0)':
            rrr <=  0.10 ? 'rgb(255 204  51)':
            rrr <=  0.20 ? 'rgb(255 175  51)':
            rrr <=  0.30 ? 'rgb(255 111   0)':
            rrr <=  0.40 ? 'rgb(230  40  30)':
                           'rgba(001,133,133,0)';
};
