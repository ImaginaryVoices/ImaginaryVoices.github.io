...
var contenu = {
    content:'En la barra de la izquierda encontrarás más información sobre este mapa interactivo:<br> &emsp;Selecciona "i" para consultar la descripción de las variables desplegadas.<br> &emsp;Elige el ícono del "gráfico" para consultar un breve análisis de los datos.<br><br><small>Pronóstico emitido el 13.08.2021.</small>'
};
...
var getColorB = function(rrr) {
    ...
    return  rrr <  -0.30 ? 'rgb(166,094,061)':
            ...
            rrr <  -0.03 ? 'rgb(238,211,101)':
            rrr <   0.00 ? 'rgb(247, 255, 234)':
            rrr ==  0.00 ? 'rgb(247, 255, 234)':
            rrr <=  0.03 ? 'rgb(247, 255, 234)':
